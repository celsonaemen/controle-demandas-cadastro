  ...
  return (
    <button
      className={cn(
        ...
        variant === "primary" && "border-primary bg-primary text-primary-foreground hover:bg-emerald-900",
        variant === "secondary" && "border-border bg-white text-slate-900 hover:border-primary hover:text-primary",
